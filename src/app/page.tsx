        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-20 md:pt-24 md:pb-28">
          <div className="flex flex-col gap-6 max-w-3xl">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <span className="text-sm text-white/70">No credit card • Cancel anytime</span>
            </div>
            <div className="flex flex-wrap gap-3 text-sm text-white/70">
              <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-white/5 border border-white/10">✓ Work + life + training in one view</span>
              ...
              <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-white/5 border border-white/10">✓ Auto-sync with TrainingPeaks & Outlook</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-700 max-w-2xl">
                You're not just an athlete—you're a parent, a professional, a partner. EnduranceBloc is the only planner that treats your job, your family, and your training as equal priorities in one honest weekly view.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-6 py-14 md:py-18">
          ...
          <div className="mt-10 p-6 rounded-2xl border border-dashed border-slate-300 bg-white text-slate-800">
            ...
            <p className="mt-2 text-slate-700 text-sm leading-relaxed">
              Review your work meetings, family commitments, and coach's training plan in one guided flow. Drag workouts to open slots, confirm sleep blocks, publish to your calendar. Start every week knowing exactly what's realistic—and what's not.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] items-center">
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex gap-3 items-start"><span className="mt-1 h-2 w-2 rounded-full bg-[#0D1D35]" aria-hidden /><span>Real-time sync keeps coach updates, calendar changes, and your plan aligned—no manual transfers.</span></li>
              </ul>
      ...
      <section className="bg-slate-900 text-white border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-14 md:py-18 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div className="space-y-3 max-w-3xl">
            ...
            <p className="text-lg text-white/80">Join athletes who've reclaimed 2+ hours per week by planning smarter. Connect your tools, complete your first Sunday Prep, and arrive at your start line confident—without sacrificing family dinners or work deadlines.</p>
          </div>
